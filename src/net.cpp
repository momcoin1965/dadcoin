...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dadcoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
<<<<<<< 6d54748bca7745e61a54c9356c45e4f85c152aa8
    0x0100007f
=======
    0x6500a8c0
>>>>>>> first
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dadcoin is probably already running."), addrBind.ToString().c_str());
        else
